---
title: "Planning — Astro + DaisyUI Registry"
...
**Phase 4 — Data & form sections (~280):** `stats` (68), `testimonials` (41),
`events` (54), `blog` (68+5), `team` (20), `timelines` (21), `comparison` (15),
`tables` (10), `pricing` (27), `forms` (81 incl. multi-step — the one big JS piece),
`gallery/portfolio` (53), `career` (27), `product` (21).

**Phase 5 — App & modal (~55):** `application-shells` (16), `sidebars` (9),
`contact/sign-up modals` (11), `cookies` (5), `loaders` (5).

**Phase 6 — Uncommon set (82):** the experimental categories, one-by-one against
screenshots; each is a small design experiment, kept behind its own file.
